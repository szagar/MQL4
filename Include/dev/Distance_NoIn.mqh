...
Enum_DIST Dist_Model   = DIST_DayAtr;
ENUM_TIMEFRAMES    DIST_atr_timeframe = 0; //>> ATR timeframe
int                DIST_atr_period = 14;   //>> ATR period
double             DIST_atr_factor = 0.10; //>> ATR factor 1-15%
